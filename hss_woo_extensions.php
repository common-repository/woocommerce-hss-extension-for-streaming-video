...
include_once(WOO_HSS_PLUGIN_DIR . 'includes/woo-myaccount-videos.php');
include_once(WOO_HSS_PLUGIN_DIR . 'includes/woo-myaccount-view-video.php');


if(!function_exists('_hss_woo_log')){
  function _hss_woo_log( $message ) {
    if( WP_DEBUG === true ){
